...
const Section3: FC<Props> = ({ filterDemo, setFilterDemo }) => {
  ...
  return (
    ...
    >
       <Box sx={{backgroundColor:'white'}} maxWidth="100%" mx="auto" mb="2.5rem" textAlign="center">
          ...
          <Typography sx={{maxWidth:'500px', mx:'auto', py:2}}>Một bộ sưu tập tuyệt vời các mẫu trang web đẹp cho nhu cầu của bạn. Chọn mẫu phù hợp nhất với bạn</Typography>
        </Box>
      <Box id="section-3" sx={{ position: "relative", width:'90%', margin:'auto' }}>

...
import TraiCayProductForm from "./TraiCayProductForm";
import ProductForm from "./ProductForm";
import EditForm from "./EditForm";
// ========================================================================
type ProductAdminRow = { product: any, title :any, setRender: (values: any) => void; };
// ========================================================================
...
const ProductAdminRow: FC<ProductAdminRow> = ({product, title, setRender}) => {
 ...
 const handleDelete =async() => {
  const result = window.confirm("Bạn có chắc xóa sản phẩm");
        if(result){
            const roomRef= doc(db, "groceries", title);

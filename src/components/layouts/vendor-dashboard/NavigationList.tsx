...
export const navigations = [
...

  {
    ...
    children: [
      { name: "Trái cây", path: "/admin/products/traicayAdmin" },
      { name: "Hủ tiếu", path: "/admin/products/hutieuAdmin" },
      { name: "Bánh kẹo", path: "/admin/products/banhkeoAdmin" },
      { name: "Khô", path: "/admin/products/khoAdmin" },
      { name: "Tổ Yến", path: "/admin/products/toyenAdmin" },

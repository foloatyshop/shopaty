...
// =============================================================================
HutieuAdmin.getLayout = function getLayout(page: ReactElement) {
...
export default function HutieuAdmin(props: ProductListProps) {
  
    const [sanpham, setSanpham] = useState([]);
    const [render, setRender] = useState(false)
    // RESHAPE THE PRODUCT LIST BASED TABLE HEAD CELL ID
    const filteredProducts = sanpham[1]?.products.map((item : any) => ({
        id: item.id,
        slug: item.name,
        name: item.name,
    ...
    return (
        ...
        <SearchArea
            ...
            handleBtnClick={() => router.push("/admin/products/hutieuAdminCreate")}
        />
        ...
        <Card>
            ...
            <TableContainer sx={{ minWidth: 900 }}>
                ...
                <TableBody>
                    ...
                    <ProductAdminRow title='hutieu' product={product} setRender={setRender} key={index} />
                    ))}
                </TableBody>
                </Table>
            </TableContainer>

...
// =============================================================================
BanhkeoAdmin.getLayout = function getLayout(page: ReactElement) {
...
export default function BanhkeoAdmin(props: ProductListProps) {
   
    const [sanpham, setSanpham] = useState([]);
    const [render, setRender] = useState(false)
    // RESHAPE THE PRODUCT LIST BASED TABLE HEAD CELL ID
    const filteredProducts = sanpham[0]?.products?.map((item :any) => ({
        id: item.id,
        slug: item.name,
        name: item.name,
    ...
    return (
        ...
        <SearchArea
            ...
            handleBtnClick={() => router.push("/admin/products/banhkeoAdminCreate")}
        />
        ...
        <Card>
            ...
            <TableContainer sx={{ minWidth: 900 }}>
                ...
                <TableBody>
                    ...
                    <ProductAdminRow title='banhkeo' product={product} setRender={setRender} key={index} />
                    ))}
                </TableBody>
                </Table>
            </TableContainer>

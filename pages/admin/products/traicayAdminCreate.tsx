...
// =============================================================================
TraiCayCreateProduct.getLayout = function getLayout(page: ReactElement) {
  return <VendorDashboardLayout>{page}</VendorDashboardLayout>;
};
// =============================================================================

export default function TraiCayCreateProduct() {
  ...
  const handleFormSubmit =async (values: typeof INITIAL_VALUES) => {
    ...
    try {
      await updateDoc(doc(db, 'groceries', 'traicay'), {
       products: arrayUnion({
         id: values.id,
         name: values.name,
         imgUrl: imgUrl,
  ...
  return (
    <Box py={4}>
      <H3 mb={2}>Thêm sản phẩm trái cây</H3>

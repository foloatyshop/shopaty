...
// =============================================================================
BanhKeoCreateProduct.getLayout = function getLayout(page: ReactElement) {
  return <VendorDashboardLayout>{page}</VendorDashboardLayout>;
};
// =============================================================================

export default function BanhKeoCreateProduct() {
  ...
  const handleFormSubmit =async (values: typeof INITIAL_VALUES) => {
    ...
    try {
      await updateDoc(doc(db, 'groceries', 'banhkeo'), {
       products: arrayUnion({
         id: values.id,
         name: values.name,
         imgUrl: imgUrl,
  ...
  return (
    <Box py={4}>
      <H3 mb={2}>Thêm sản phẩm bánh kẹo</H3>

...
// =============================================================================
KhoAdmin.getLayout = function getLayout(page: ReactElement) {
...
export default function KhoAdmin(props: ProductListProps) {
    const { products } = props;
    const [sanpham, setSanpham] = useState([]);
    const [render, setRender] = useState(false)
    // RESHAPE THE PRODUCT LIST BASED TABLE HEAD CELL ID
    const filteredProducts = sanpham[2]?.products.map((item : any) => ({
        id: item.id,
        slug: item.name,
        name: item.name,
    ...
    return (
        ...
        <SearchArea
            ...
            handleBtnClick={() => router.push("/admin/products/khoAdminCreate")}
        />
        ...
        <Card>
            ...
            <TableContainer sx={{ minWidth: 900 }}>
                ...
                <TableBody>
                    ...
                    <ProductAdminRow title='kho' product={product} setRender={setRender} key={index} />
                    ))}
                </TableBody>
                </Table>
            </TableContainer>
